...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  XXXXXXX, XXXXXXX, LT(1,KC_ESC), MT(MOD_LCTL,KC_SPC), MT(MOD_LSFT, KC_TAB),  /*||*/  LT(3,KC_ENT), LT(2,KC_BSPC), LT(4,KC_DEL), XXXXXXX, XXXXXXX
    ...
    [3] = LAYOUT(
        ...
        KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_PIPE,  KC_QUOTE, KC_NO,   KC_NO,   KC_RALT, KC_NO,
        XXXXXXX, XXXXXXX, KC_LPRN, KC_RPRN, MT(MOD_LSFT, KC_UNDS), KC_NO,   KC_NO,   KC_NO, XXXXXXX, XXXXXXX
    ),
